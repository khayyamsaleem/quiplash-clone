        ...
        <Navbar fixed="top" style={{backgroundColor: '#00649b'}} expand="lg">
          ...
          <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end" style={{ float: 'right'}}>
            <Nav>
              ...
              <Nav.Link href="/CreatePublic" style={{color: 'white'}}><Button style={{backgroundColor: '#26A69A'}} onClick={() => this.setState({ modalShow: true })}>Create a Public Room</Button></Nav.Link>
