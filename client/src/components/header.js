      ...
      <>
        <Navbar fixed="top" style={{backgroundColor: '#00649b'}} expand="lg">
          ...
          <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end" style={{ float: 'right'}}>
            <Nav>
              <Nav.Link href="/createprivate" style={{color: 'white'}}><Button style={{backgroundColor: '#66BB6A'}} id="public">Create a Private Room</Button></Nav.Link>
              ...
              <Nav.Link href="/joinpublic" style={{color: 'white'}}><Button style={{backgroundColor: '#BA68C8'}}>Join a Room</Button></Nav.Link>
